...
<html lang="zh-cn">
  <head>
    ...
    <meta name="description" content="OrangeXi云后台管理系统">
    <meta name="author" content="jack">
    <link rel="shortcut icon" href="${baseUrlStatic}/icon/favicon.png">
    <title>OrangeXi后台管理系统</title>
    <!-- Bootstrap core CSS -->
...
<body style="padding-top: 50px;">
    ...
    <script type="text/javascript" src="${baseUrlStatic}/My97DatePicker/WdatePicker.js"></script>
